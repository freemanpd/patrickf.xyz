"""
Django settings for patrickf-backend project.
...
ALLOWED_HOSTS = ['patrickf.xyz', 'app', '127.0.0.0.1', 'localhost']
...
ROOT_URLCONF = 'patrickf-backend.urls'
...
WSGI_APPLICATION = 'patrickf-backend.wsgi.application'
